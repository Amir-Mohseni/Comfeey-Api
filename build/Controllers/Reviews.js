...
var Review_1 = require("../Validators/Review");
var utils_1 = require("../utils/utils");
// Passed
// Creating Review
exports.createReviewController = (0, utils_1.tryCatchWrapper)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var validated, createdReview;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, Review_1.createReviewSchema.validateAsync(req.body)];
            case 1:
                validated = _a.sent();
                if (!validated)
                    throw new Error('ValidationError');
                return [4 /*yield*/, (0, Reviews_1.createReview)(req.body)];
            case 2:
